...
<body>
    <div>
        <h1>正解です！</h1>
        <p>おめでとうございます、あなたは問題を正解しました。</p>
        <button onclick="redirectToNextPage()">一覧へ戻る</button>
    </div>

    <script>
        // ボタンがクリックされたときに次のページにリダイレクトする関数
        function redirectToNextPage() {
            // ここに次のページへのリダイレクト処理を追加
            window.location.href = "http://localhost/TrueOrFalseQuiz";
        }
    </script>
</body>
</html>
